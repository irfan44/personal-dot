...
beautiful.init("/home/irfannm/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "r",     function () awful.spawn.with_shell("rofi -show drun") end,
        ...
        awful.key({ modkey, "Shift"},            "r",     function () awful.spawn.with_shell("rofi -show run") end,
...
awful.key({},            "XF86MonBrightnessDown",     function () awful.spawn.with_shell("xbacklight -dec 1") end,
              ...
              awful.key({ modkey, "Shift"},            "e",     function () awful.spawn.with_shell("i3lock-fancy -gp -- scrot -z") end,
...
awful.key({"Shift"},            "Print",     function () awful.spawn.with_shell("gnome-screenshot -a") end,
              {description = "snip screenshot", group = "screen"}),
...
-- Added Settings
awful.spawn.with_shell("feh --bg-scale ~/Pictures/Wallpapers/mountains.jpg")
